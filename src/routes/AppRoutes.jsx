...
const BookingDetail = lazy(
  () => import("../components/pages/clients/BookingDetail"),
);

const LandlordDashboard = lazy(
  () => import("../components/pages/landlord/LandlordDashboard"),
);

const LandlordRooms = lazy(
  () => import("../components/pages/landlord/LandlordRooms"),
);

const CreateRoom = lazy(
  () => import("../components/pages/landlord/CreateRoom"),
);

const LandlordBookings = lazy(
  () => import("../components/pages/landlord/LandlordBookings"),
);

const EditRoom = lazy(() => import("../components/pages/landlord/EditRoom"));

const LandlordEarnings = lazy(
  () => import("../components/pages/landlord/LandlordEarnings"),
);

const LandlordProfile = lazy(
  () => import("../components/pages/landlord/LandlordProfile"),
);

const LandlordSettings = lazy(
  () => import("../components/pages/landlord/LandlordSettings"),
);
...
const AdminBookings = lazy(
  () => import("../components/pages/admin/AdminBookings"),
);

const AdminReports = lazy(
  () => import("../components/pages/admin/AdminReports"),
);

const AdminProfile = lazy(
  () => import("../components/pages/admin/AdminProfile"),
);

const AdminSettings = lazy(
  () => import("../components/pages/admin/AdminSettings"),
);
